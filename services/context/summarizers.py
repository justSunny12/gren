...
0. Не пиши заголовков и не форматируй текст, не общайся и не пиши вводных слов - только конспект
...
0. Не используй заголовки, форматирование и Markdown, не общайся и не пиши вводных слов - только конспект
